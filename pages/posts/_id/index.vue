<template>
  <div class="single-post-page">
    <section class="post">
      <!-- <h1 class="post-title">{{ loadedPosts.name }}</h1> -->
...
export default {
    async asyncData({$axios ,params}){
        const ip = await $axios.$get('https://first-nuxt-project-a269a-default-rtdb.firebaseio.com/posts/'+ params.id + '.json')
        return {loadedPosts: ip}
    }    
}
